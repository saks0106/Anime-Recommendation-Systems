...
st.subheader(
    'Based on the Anime :movie_camera: & Recommendation Engine :rocket: You Select, We will Recommend :smiling_face_with_3_hearts: you another 5 Animes :star:  to Binge Watch! '':heart_eyes:')
